...
import { connectWithUser, dismissUser } from "@/app/matching/actions";
...
const META_ICONS = { degree: '🎓', gender: '✨' }
const META_LABELS = { degree: 'Studying', gender: 'Pronouns' }
const PRONOUNS = {
    female: 'She / her',
    male: 'He / him',
        ...
        return (
            <div className={styles.empty}>
                ...
                <p className={styles.emptyText}>
                    Check back soon — new people are joining all the time.
                </p>
            </div>
        )
    }
    ...
    return (
        <div className={styles.feed}>
            {items.map((item, i) => {
                ...
                const dismiss = dismissUser.bind(null, item.id)
                    ...
                    <div className={styles.cardWrap} key={item.id}>
                        <article className={styles.card}>
                            <div className={styles.banner} style={{ background: `linear-gradient(135deg, ${c1}, ${c2})` }}>
                                ...
                                <form action={dismiss} className={styles.dismissForm}>
                                    <button type="submit" className={styles.dismiss} aria-label="Dismiss">✕</button>
                                </form>
                            </div>
